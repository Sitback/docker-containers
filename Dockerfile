...
RUN yum install which htop nano tar git mod_ssl openssl httpd php php-devel nginx php-fpm -y
...
#RUN git clone https://github.com/paulhudson/drupal-with-nginx.git
